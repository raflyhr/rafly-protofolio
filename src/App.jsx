...
const credentials = [
  ['Certificate', 'Pengenalan ke Logika Pemrograman', '/sertif1.png', 'Mempelajari konsep dasar logika pemrograman untuk membangun solusi terstruktur.'],
  ['Certificate', 'Belajar Dasar AI', '/sertif2.png', 'Mempelajari konsep, peluang, dan penerapan dasar kecerdasan artifisial.'],
  ['Certificate', 'Belajar Fundamental Aplikasi Web dengan React', '/sertif3.png', 'Mempelajari dasar React untuk membangun aplikasi web interaktif.'],
  ['Certificate', 'Belajar Membuat Aplikasi Web dengan React', '/sertif4.png', 'Membangun aplikasi web modern menggunakan komponen dan state React.'],
  ['Certificate', 'Belajar Membuat Front-End Web untuk Pemula', '/sertif5.png', 'Mempelajari dasar pengembangan antarmuka web responsif.'],
  ['Certificate', 'Belajar Fundamental Back-End dengan JavaScript', '/sertif6.png', 'Mempelajari konsep back-end, API, dan JavaScript di sisi server.'],
  ['Certificate', 'Belajar Back-End Pemula dengan JavaScript', '/sertif7.png', 'Mempelajari dasar pengembangan layanan back-end dengan JavaScript.'],
  ['Certificate', 'Belajar Dasar Pemrograman JavaScript', '/sertif8.png', 'Mempelajari sintaks dan konsep dasar JavaScript untuk pengembangan web.'],
  ['Certificate', 'Belajar Dasar Cloud dan Gen AI di AWS', '/sertif9.png', 'Mempelajari dasar cloud computing dan generative AI di AWS.'],
  ['Certificate', 'Memulai Dasar Pemrograman untuk Menjadi Pengembang Software', '/sertif10.png', 'Mempelajari fondasi pemrograman untuk memulai karier pengembang software.'],
  ['Certificate', 'Belajar Dasar Pemrograman Web', '/sertif11.png', 'Mempelajari fondasi HTML, CSS, dan konsep dasar pengembangan web.'],
]
